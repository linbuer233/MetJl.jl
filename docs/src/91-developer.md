...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/linbuer233/MetJl.jl
   ```
...
- After that runs, the [stable docs](https://linbuer233.github.io/MetJl.jl/stable) should be updated. Check them and look for the version number.
